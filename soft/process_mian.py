...
# #############################################
from process import *
from utils.m_ir_vis_reg import image_matching,undistort
# #############################################
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.BAR_BUTTON.clicked.connect(self.undistort)
    ...
    def fusion(self):
        best_pa,fusion_img = image_matching(self.ir_filename,self.vis_filename)
        self.setPhoto_RES(fusion_img)

    def undistort(self):
        img = undistort(self.VIS_img,0.0019,4.5,2)
        self.setPhoto_RES(img)
